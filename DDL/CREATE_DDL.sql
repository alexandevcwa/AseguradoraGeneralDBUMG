...
(
    ...
    IDDEPTO   NUMBER(4, 0)   NOT NULL,        --ID DEL DEPARTAMENTO AL QUE PERTENECE EL CLIENTE
...
(
    ...
    MODELO         NUMBER(4, 0)  NOT NULL,    --MODELO DEL VEHICULO
    CILINDROS      NUMBER(2, 0)  NOT NULL,    --CILINDROS DEL VEHICULO
    COLOR          NVARCHAR2(48) NOT NULL,    --COLOR DEL VEHICULO DESCRITO EN LETRAS
...
WHERE VEHICULOS.IDMARCA = MARCAS.IDMARCA;